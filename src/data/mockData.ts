...
export const mockStories: Story[] = [
  ...
  },
  {
    ...
    content: 'When starting in web development, choosing the right framework is crucial. In this guide, we break down the top tools used by industry professionals and explain why we teach React and Vite at Brandex. Learning these modern stacks early prepares students for real-world internships and scalable production environments.',
    coverImage: '/geniusphere-banner.webp',
    author: 'Pavan Kumar.S',
  ...
  },
  {
    ...
    content: 'Capture The Flag (CTF) competitions are the best way to learn ethical hacking. We cover the essential tools like Wireshark, Nmap, and Burp Suite that you need to master. Join our next Brandex cybersecurity workshop to practice these skills in a safe, sandboxed environment against live targets.',
    coverImage: '/geniusphere-collab-ghibli.webp',
    author: 'Sathvik.N',
  ...
  },
  {
    ...
    content: 'Artificial Intelligence is no longer sci-fi. In our latest Geniusphere series, we break down how Transformers and Large Language Models actually work under the hood. We teach students how to interact with APIs and build their own autonomous agents using open-source models.',
    coverImage: '/geniusphere-collab-ghibli.webp',
    author: 'Pavan Kumar.S',
  ...
  },
  {
    ...
    content: 'Open-source is the backbone of modern software. At Brandex, we encourage every member to push code to public GitHub repositories. Not only does this build a strong portfolio for college applications, but it also fosters a culture of shared knowledge and peer review.',
    coverImage: '/geniusphere-banner.webp',
    author: 'Sathvik.N',
