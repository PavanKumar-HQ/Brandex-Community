...
class CRMService {
     ...
     */
    async getLeadStatusByRefAndEmail(refCode, email) {
     ...
     */
    updateLeadStatus(refCode, newStatus, notes) {
    ...
    purgeExpiredEnquiries() {
        ...
        this.temporaryWebsiteEnquiries = this.temporaryWebsiteEnquiries.filter(enq => new Date(enq.expiresAt).getTime() > now);
