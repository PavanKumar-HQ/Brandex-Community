...
export const IdentityModal: React.FC<IdentityModalProps> = ({
  ...
  useEffect(() => {
    if (isOpen) {
      ...
      setHandleInput(getOrCreateIdentity().handle);
        ...
        <div className="flex items-center gap-4 mb-6">
          <div className="relative">
            <img
              ...
              className="w-16 h-16 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-700"
            />
            <span
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex items-center gap-2 mt-1">
              ...
              <span className="text-[11px] font-mono text-slate-400">Zero-PII Token</span>
            </div>
          </div>
        </div>
